...
//设置界面元素 
		...
		labelHelp = new JLabel("按 F或S 键改变速度", JLabel.CENTER);
		panelButtom.add(labelHelp, BorderLayout.NORTH);
		labelHelp = new JLabel("按 R键 重新开始游戏", JLabel.CENTER);
		panelButtom.add(labelHelp, BorderLayout.CENTER);
		labelHelp = new JLabel("按 P键 暂停游戏", JLabel.CENTER);
...
class SnakeModel implements Runnable {
	...
	double speedChangeRate = 0.5;// 速度改变程度
